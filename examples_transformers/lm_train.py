...
class ProfCallback(TrainerCallback):
    def __init__(self, prof, et, et_step, et_file):
        self.prof = prof
        
        self.et = et
        self.et_step = et_step
        self.et_file = et_file

    def on_step_begin(self, args, state, control, **kwargs):
        self.prof.step()

        if self.prof.step_num == self.et_step:
            print("ET start at step = {}".format(self.prof.step_num))
...
def main():
    ...
    if training_args.do_train:
        ...
        def trace_handler(prof):
            kineto_file = "./kineto/worker_"+str(training_args.local_rank)+"_step_"+str(prof.step_num)
        ...
        # Profiler
        et_file = "./et/worker_" + str(training_args.local_rank) + ".json"
        ...
        trainer.add_callback(ProfCallback(prof=prof, et=et, et_step=4, et_file=et_file))
