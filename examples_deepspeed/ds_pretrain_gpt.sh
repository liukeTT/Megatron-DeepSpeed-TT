...
WARMUP_TOKENS=$(( ${SEQ_LEN} * 2 ))
# LR_DECAY_TOKENS=260000000000
# LR_DECAY_TOKENS=300000000000
LR_DECAY_TOKENS=$(( ${SEQ_LEN} * 2 ))
###############################################################################
### Parallelism configs
...
run_cmd="deepspeed pretrain_gpt.py ${megatron_options} ${data_options} ${deepspeed_options} > ${OUTPUT_BASEPATH}/log/${NAME}_${host}_${current_time}.log"
echo ${run_cmd}
eval ${run_cmd}
set +x